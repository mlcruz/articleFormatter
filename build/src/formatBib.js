...
program
    ...
    .option("-l, --ltwa [Ltwa Input File]", "Ltwa file location  - Defaults to outfile.bib ")
    .option("-o, --out [Ltwa Input File]", "output file location - Defaults to tableData.csv")
    .option("-s, --short [Short words Input File]", "Short words file location location - Defaults to shortwords.txt ")
    .parse(process.argv);
